      ...
      {!showRoadMap ? (
        <div className="flex flex-col items-center justify-center min-h-screen">
          <h2 className="text-3xl font-semibold mb-2">
            {courseData?.content?.course_name || "Course"}
          </h2>
                ...
                style={{
                  border:
                    selectedTopicName === topic.name
                      ? `1.5px solid ${linearGradientBackground}`
                      : "none",
                }}
              >
                <input
                  ...
                  name="topic"
                  value={index}
                  checked={selectedTopicName === topic.name}
                  onChange={() => {}}
            ...
            <>
              {selectedOption === "QuizzesLevel" ? (
                ...
                <div className="flex flex-col items-center justify-center min-h-screen ">
                  ...
                  {showPopup &&
                    selectedTopic?.subtopics.find((_, index) => index === selectedSubtopicId) && (
                            ...
                            <h3 className="text-xl font-semibold mb-2">
                              {
                                selectedTopic.subtopics.find(
                                  (_, index) => index === selectedSubtopicId
                                )?.name
                              }
                            </h3>
