            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className="border-0 rounded-3xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="flex items-start justify-between p-5">
                  <h3 className="text-xl font-semibold">Add Sub topics Details</h3>
                  <button
                ...
                <form>
                  <div className="flex items-start justify-between mt-5 px-5">
                    <label htmlFor="Sub Topic" className="font-semibold text-lg text-gray-500">
                      Sub Topic
                    </label>
                  </div>
                  ...
                  <div className="flex items-start justify-between mt-5 px-5">
                    <label htmlFor="SubTopicDesc" className="font-semibold text-lg text-gray-500">
                      Sub Topic Desc
                    </label>
                  </div>
                  <div className="flex w-full items-start justify-between px-5">
