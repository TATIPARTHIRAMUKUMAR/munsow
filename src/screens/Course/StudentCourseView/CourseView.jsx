...
const StudentCourseView = () => {
    ...
    const [language, setLanguage] = useState('hi'); // 'hi' for Hindi, 'te' for Telugu

    const translateText = async (text) => {
        const apiKey = 'key_for_translation'; // Use your actual API key
        const projectId = '54851968670d10bf556011.04752848'; // Replace with your actual project ID
        const lokaliseEndpoint = `https://api.lokalise.com/api2/projects/${projectId}/auto_translations`;
        ...
        try {
            ...
            // Assuming the API returns the translated text in response.data.translation
            setTranslatedText(response.data.translation || 'No translation available');
        } catch (error) {
    ...
    return (
        <div>
            ...
            />
            <br />
            <button onClick={() => setLanguage('hi')}>Translate to Hindi</button>
            <button onClick={() => setLanguage('te')}>Translate to Telugu</button>
