...
const StudentCourseView = () => {
  ...
  const cardColor = isDarkMode ? colorTheme.dark.cardColor : colorTheme.light.cardColor;
  ...
  useEffect(() => {
    const firstUncompletedSubtopic = detailedCourse?.content_data
  ...
  const calculateProgress = () => {
    ...
    const totalSubtopics = detailedCourse.content_data.reduce(
    ...
    <div className="p-4">
      ...
      <div className="flex w-full">
        <div className="w-4/6 p-4 overflow-y-auto rounded-lg mr-4">
          ...
          {selectedSubtopic && (
            <div>
              {parseHTMLContent(translatedContent || selectedSubtopic.content).map(
                (word, index) => (
                  <span
                    key={index}
                    style={{
                      backgroundColor:
                        index === currentWordIndex ? linearGradientBackground : "transparent",
            ...
            <div className="flex justify-end">
              ...
              <Button
                ...
                disabled={
                  ...
                  currentSubtopicIndex === topics[topics?.length - 1]?.subtopics?.length - 1
                }
              >
                Next
              </Button>
          ...
          <div className={`p-5 bg-[#${cardColor}] rounded-xl`}>
            ...
            <div className="mt-5">
              ...
              {detailedCourse?.content_data?.map((topic, topicIndex) => {
                const isDefaultOpen = topic?.subtopics?.some(
                  sub => sub === selectedSubtopic && !sub?.completed
                );
                return (
