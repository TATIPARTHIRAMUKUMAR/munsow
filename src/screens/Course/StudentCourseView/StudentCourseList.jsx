...
const CourseCard = ({ course, onClick, title }) => {
  ...
  const handleDeleteConfirm = () => {
    dispatch(
      delete_course(course.course_id, resp => {
  ...
  return (
    ...
    >
      <img
        src={bannerImg}
        alt="Course"
        className={` ${title === "Continue Learning..." ? "w-[228px]" : "w-[228px]"}   max-w-full h-auto m-3 rounded-lg object-cover`}
      />
      <div className="p-6">
              ...
              >
                ...
                >
                  <img
                    src={bannerImg}
                    alt="Course"
                    className="w-[228px] max-w-full h-auto m-3 rounded-lg object-cover"
                  />
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      <motion.button
                        ...
                        onClick={() =>
                          handleEnrollClick({
                            course_name: "Virginia Tech",
                            course_description:
                              "This program is designed for students to specialize in drones technology.",
                          })
                        }
                        style={{
                          backgroundColor: linearGradientBackground,
...
const TaskManager = () => {
  ...
  const handleCheckboxChange = (assignment, checked) => {
    setAssignments(
      assignments.map(a => (a.name === assignment.name ? { ...a, completed: checked } : a))
    );
  };
    ...
    <div className="container mx-auto p-4">
      {courses ? (
          ...
          {selectedBanner ? (
                ...
                {selectedBanner.courses.map(course => (
                  ...
                  >
                    <img
                      src={bannerImg}
                      alt="Course"
                      className={`w-[240px] max-w-full h-auto rounded-lg object-cover`}
                    />
            ...
            <>
              {banner[0].courses.length !== 0 && (
                <div
                  className="image-container relative mx-8 my-5"
                  onClick={() => handleBannerClick(banner[0])}
                >
                  <img
                    src={bannerImg2}
                    alt="Banner"
                    className="w-full h-[270px] object-cover object-center rounded-lg shadow-lg hover:shadow-2xl cursor-pointer"
                  />
                </div>
              )}
        ...
        <div className="flex items-center justify-center flex-col">
          ...
          <h1 style={{ color: "grey" }} className="font-bold text-4xl mt-8">
