...
function TopicSubtopic({ setTopics }) {
  ...
  const handleSave = () => {
    if (newTopic.name === "") {
      ...
      setData(prevData => [
        ...prevData,
        { id: prevData.length + 1, name: newTopic.name, isHidden: false },
      ]);
      closeModal();
    }
  };
  ...
  const handleSubDelete = () => {
    const subTopicIndex = Topicdata[topicIndex.current].subtopics.findIndex(
      name => name.id === subDeleteId.current
    );

    let updatedSubtopics = [
      ...Topicdata[topicIndex.current].subtopics.slice(0, subTopicIndex),
      ...Topicdata[topicIndex.current].subtopics.slice(subTopicIndex + 1),
    ];
    const updatedTopic = { ...Topicdata[topicIndex.current], subtopics: updatedSubtopics };

    Topicdata = [
      ...Topicdata.slice(0, topicIndex.current),
      updatedTopic,
      ...Topicdata.slice(topicIndex.current + 1),
    ];
  ...
  const toggleAccordion = (index, subIndex) => {
    const updatedTopicData = [...Topicdata];
    updatedTopicData[index].subtopics[subIndex].isDescHidden =
      !Topicdata[index].subtopics[subIndex].isDescHidden;
    setData(updatedTopicData);
  };
  ...
  const topicNames = Topicdata.map((name, index) => (
    <>
          ...
          <>
            <tr className="flex flex-col md:flex-row justify-between">
              <td style={{ backgroundColor: "white", display: "flex", alignItems: "center" }}>
                <FontAwesomeIcon
                  style={{ backgroundColor: "white", marginRight: "15px", color: "gray" }}
                  icon={faBars}
                />
                <input
                  type="text"
              ...
              <td style={{ backgroundColor: "white", display: "flex", gap: "10px" }}>
                <button onClick={cancelEditing} className="cancelEditButton">
                  Cancel
                </button>
                <button onClick={() => saveEditing(index)} className="saveEditButton">
                  Save
                </button>
              </td>
            </tr>
                ...
                <tr>
                  ...
                  <td style={{ width: "15%", paddingLeft: "95px" }}>
                    <button className="functionButton" onClick={() => visible(index)}>
                      <FontAwesomeIcon
                        style={{ backgroundColor: "#d9d9d9", fontSize: "20px" }}
                        icon={faEye}
                      />
                    </button>
                  </td>
                ...
                <tr className="flex flex-col md:flex-row justify-between">
                  ...
                  <td style={{ backgroundColor: "white", display: "flex", alignItems: "center" }}>
                    <button className="functionButton" onClick={() => openSubModal(index)}>
                      <FontAwesomeIcon
                        style={{ backgroundColor: "white", marginLeft: "20px", fontSize: "20px" }}
                        icon={faPlusCircle}
                      />
                    </button>

                    <button
                      onClick={() => startEditing(index, name.name)}
      ...
      {name.subtopics &&
        name.subtopics.map((name, subIndex) => (
          <li
          ...
          >
            {
              <>
                {Topicdata[index].subtopics[subIndex].isHiddenSub ? (
                  <div className="hide">
                    <tr>
                      ...
                      <td className="hide" style={{ width: "15%", paddingLeft: "74px" }}>
                        <button
                          className="functionButton"
                          onClick={() => visibleSubTopic(index, subIndex)}
                        >
                          <FontAwesomeIcon
                            style={{ backgroundColor: "#d9d9d9", fontSize: "20px" }}
                            icon={faEye}
                  ...
                  <tr style={{ display: "flex", justifyContent: "space-between" }}>
                    <td style={{}}>
                      <button
                        className={`accordion ${Topicdata[index].subtopics[subIndex].isDescHidden ? "active" : ""}`}
              ...
              <FontAwesomeIcon className={`downButton ${Topicdata[index].subtopics[subIndex].isDescHidden ? 'rotateDownButton' : ''}`} icon={faChevronDown} />
                      ...
                      <div
                        className={`panel ${Topicdata[index].subtopics[subIndex].isDescHidden ? "active" : ""}`}
                      >
                    ...
                    >
                      <button
                        onClick={() =>
                          openSubEditModal(index, subIndex, {
                            name: name.name,
                      ...
                      <button
                        onClick={() => toggleVisibilitySubTopic(index, subIndex)}
                        className="functionButton"
                      >
                        <FontAwesomeIcon
                          style={{ backgroundColor: "white", marginLeft: "20px", fontSize: "20px" }}
                      ...
                      <button
                        onClick={() => openSubDeleteModal(name.id, index)}
                        className="functionButton"
                        style={{}}
                      >
                        <FontAwesomeIcon
  ...
  return (
    <div className="Main">
      <div className="header">
        ...
        <button
          type="button"
          className="text-lg md:text-xl createButton"
          onClick={openModal}
          style={{ backgroundColor: "#10e4d4" }}
        >
          Create Topic
          <FontAwesomeIcon
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <div className="inline-flex flex-col mb-5">
              ...
              />
              {validationMessage && <p className="invalidMessage">{validationMessage}</p>}
            </div>
            <div className="flex gap-4 items-center">
              <button onClick={cancelEditing} className="cancelEditButton">
                Cancel
              </button>
              <button onClick={handleSave} className="saveEditButton">
                Save
              </button>
            </div>
          </div>
        ...
        <div className="modal" style={{ overflow: "scroll" }}>
          <div className="modal-content" style={{ overflow: "scroll" }}>
            ...
            <div className="inline-flex flex-col mb-5">
              ...
              />
              {validationMessage && <p className="invalidMessage">{validationMessage}</p>}
              <label className="my-3" htmlFor="topicName">
          ...
          {validationDescMessage && (
            ...
            <div className="flex gap-4 items-center">
              ...
              <button onClick={handleSubTopicSave} className="saveEditButton">
                Save
              </button>
            </div>
          </div>
      ...
      {isDeleteModalOpen && (
        <div className="modal">
          <div className="modals-content">
            ...
            <p className="deleteLabel">Are You Sure You Want To Delete This Topic?</p>
            <br />
            <button
              onClick={closeDeleteModal}
              className="cancelEditButton mr-5"
              style={{ marginLeft: "290px" }}
            >
              Cancel
            </button>
            <button onClick={handleDelete} className="saveEditButton">
              Delete
            </button>
          </div>
        </div>
      ...
      {isSubDeleteModalOpen && (
        <div className="modal">
          <div className="modals-content">
            ...
            <p className="deleteLabel">Are You Sure You Want To Delete This Sub-Topic?</p>
            <br />
            <div className="flex gap-4 items-center">
              <button onClick={closeSubDeleteModal} className="cancelEditButton">
                Cancel
              </button>
              <button onClick={handleSubDelete} className="saveEditButton">
                Delete
              </button>
            </div>
          </div>
        ...
        <div className="modal">
          ...
          {validationDescMessage && (
            ...
            <div className="flex gap-4 items-center">
              ...
              <button onClick={handleEdit} className="saveEditButton">
                Save
              </button>
            </div>
          </div>
