...
export default function StudentDashboard() {
  ...
  return (
    <div style={{ background: backgroundColor }} className="px-6 py-6">
      <div className=" gap-7  relative overflow-auto max-w-full h-auto">
        ...
        <div className="my-5 flex flex-col sm:flex-row justify-evenly mb-5 w-[100%] gap-4 relative overflow-auto max-w-full ">
          <div className=" w-[100%] sm:w-[63%] relative bg-white overflow-auto max-w-full rounded-lg">
          {averageScores ? (
          <div className="flex ">
            <div className="w-[33%]">
          ...
          <div className=" w-[100%] sm:w-[37%] relative overflow-auto max-w-full">
