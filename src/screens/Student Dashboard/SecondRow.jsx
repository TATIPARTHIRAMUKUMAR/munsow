...
const SecondRow = () => {
  ...
  return (
    <div className="col-span-1 bg-white rounded-lg px-6 py-6">
      <p className="text-[#886cc0] text-lg  font-semibold p-2">
        ...
        <div className="flex justify-between items-center pt-4">
          <div className="flex flex-row justify-start items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-opacity-50 text-sm font-semibold">
                {data?.soft_skill > 0 ? "Increased by" : "Decreased by"}{" "}
                {Math.abs(data?.soft_skill)}%
              </p>
            </div>
          </div>
          <div>
