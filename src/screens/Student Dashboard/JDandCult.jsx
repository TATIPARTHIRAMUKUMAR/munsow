      ...
      <div className="p-5">
        <div className="flex justify-between items-center">
          <div className="flex flex-row justify-start text-md font-bold items-center space-x-3 ml-3">
            ...
            <div>
              <Typography variant="h7" style={{ color: textColor }}>
        ...
        <div className="flex justify-between items-center mt-7">
          ...
          <div className="text-lg font-bold">{data[1]?.value}</div>
        </div>
        <div className="flex justify-between items-center mt-7">
          <div className="flex flex-row justify-start text-md font-bold items-center space-x-3 ml-3">
            <div className="flex-shrink-0">
          ...
          <div className="text-lg font-bold">{data[2]?.value}</div>
        </div>
        <div className="flex justify-between items-center mt-7">
          <div className="flex flex-row justify-start text-md font-bold items-center space-x-3 ml-3">
            <div className="flex-shrink-0">
          ...
          <div className="text-lg font-bold">{data[3]?.value}</div>
        </div>
      </div>
    </div>
  );
