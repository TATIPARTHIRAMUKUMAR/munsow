        ...
        >
          <div className="flex items-center justify-between">
            ...
            >
              <span
                ...
                style={{
                  transform: reportAlertsEnabled ? "translateX(24px)" : "translateX(0px)",
          ...
          <div className="flex items-center justify-between">
            <label htmlFor="notifications" className="w-[350px] text-sm font-medium text-gray-600">
              Opt in for new updates on Munsow and get notified when more features are added to the
              platform
            </label>
            <button
              type="button"
              ...
              className=" relative inline-flex items-center h-6 rounded-full w-11 transition-colors focus:outline-none"
              style={{
                background: munsowUpdatesAlertsEnabled ? buttonColor : "lightGray",
              }}
            >
              <span
                className="inline-block w-5 h-5 transform translate-y-0.4 rounded-full transition-transform"
                style={{
                  transform: munsowUpdatesAlertsEnabled ? "translateX(24px)" : "translateX(0px)",
                  background: munsowUpdatesAlertsEnabled ? "white" : headerTextColor,
                }}
              />
            </button>
          </div>
