...
const UserReportPartFour = ({ userData, user }) => {
  const [data, setData] = useState({});

  useEffect(() => {
    const filteredData = userData?.data.filter(o => o.main_title === "Practical Thinking Scores");
        ...
        <div className="md:w-11/12">
          ...
          <div className="md:flex">
            ...
            <div className="md:w-8/12 p-4 md:mt-4">
              ...
              <div>
                <p
                  className="md:text-lg md:font-medium text-break text"
              ...
              return (
                <>
                  <div className="md:w-6/12 p-4 md:mt-4">
                    <div>
                      <span
                        className={`md:text-xl md:font-semibold ${getScoreClass(o?.secured_marks, o?.total_marks)}`}
                      >
                    ...
                    <div style={{ marginLeft: "60px" }}>
                      <p
                        className="md:text-lg md:font-semibold text-break text mt-2"
                ...
                <div className="bg-gray-100 m-5">
                  ...
                  <div className="md:flex">
                    <div className="md:w-6/12 p-4">
                      <div>
                        <span
                          className="md:text-2xl md:font-semibold text"
