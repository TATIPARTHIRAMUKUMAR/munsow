        ...
        <div className="m-6">
          <div class="p-4 bg-yellow-100 rounded-2">
            <p class="text-yellow-800">
              Please note that the values on this page are not editable at the moment. Kindly
              contact our team at{" "}
        ...
        <div className="bg-white max-[525px]:px-6 px-12 md:px-24 py-12">
          ...
          <div>
            <AvatarContainer>
              ...
              <StyledInput id="avatar-input" type="file" onChange={handleAvatarChange} />
            ...
            <div className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-8 lg:max-w-none lg:grid-cols-2 lg:gap-y-8">
              <div className="">
                ...
                <TextField
                  ...
                  onChange={event => onLogingChange("first_name", event.target.value)}
                />
              </div>
              <div>
                <p className="mb-1 text-gray-400 text-sm">
                ...
                <TextField
                  ...
                  onChange={event => onLogingChange("last_name", event.target.value)}
                />
              </div>
              ...
              <div className="">
                ...
                <TextField
                  ...
                  onChange={event => onLogingChange("phone_number", event.target.value)}
                />
              </div>
              <div>
                <p className="mb-1 text-gray-400 text-sm">
          ...
          <div className="flex justify-end my-8">
            <button
              className="border rounded-lg max-[425px]:p-2 p-3 mr-5 shadow-md"
              style={{ border: `2px solid ${background}`, color: textColor }}
              onMouseEnter={e => {
            ...
            <button
              ...
              className="border rounded-lg max-[425px]:p-2 p-3 shadow-md"
