...
const TranscriptionPopup = ({ isOpen, message, onRestart, onClose }) => {
  ...
  const alertTitle = isNetworkIssue
...
const PremiumSpeechTranscription = ({
  ...
  const handleNetworkError = () => {
    ...
    showRestartPopup(
      "Network error detected. Transcription will resume automatically when your connection is restored."
    );
  ...
  useEffect(() => {
    ...
    if (confidenceScore < 0.3) {
      ...
      if (lowClaritySamples >= 3 && !lowClarityDetected) {
        ...
        showRestartPopup(
          "Low voice clarity detected. Your speech may not be recognized correctly. Transcription will restart automatically."
        );
      ...
      recognition.onerror = event => {
        switch (event.error) {
          ...
          case "audio-capture":
            ...
            showRestartPopup(
              "Microphone connection issue detected. Transcription will restart automatically."
            );
          ...
          default:
            ...
            showRestartPopup(
              `Speech recognition issue: ${event.error}. Transcription will restart automatically.`
            );
        }
      ...
      <div className="live-transcription-container">
        ...
        >
          ...
          <p style={{ margin: "10px 0", color: "#333" }}>
            Microphone access is required for speech recognition. Please allow microphone access in
        ...
        <>
          ...
          >
            ...
            <div style={{ fontSize: "12px", color: "#666", marginTop: "5px" }}>
              When enabled, transcription will automatically restart when unplugging headphones or
