        ...
        <>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center justify-between">
              ...
              <label
                htmlFor="file-upload"
                className="bg-indigo-500 text-white py-2 px-6 rounded-lg cursor-pointer hover:bg-indigo-600 transition-colors duration-300"
              >
                Choose File
              </label>
              {jobDetails.file && <span className="ml-4 text-gray-700">{fileName}</span>}
            </div>
          </div>
          <div className="flex justify-center">
            <button
              className={`py-2 px-8 rounded-lg mr-4 transition-colors duration-300 ${
                handleDisable()
          ...
          <div className="bg-gray-100 rounded-lg p-6">
            {multiSelectOptions.map((option, index) => (
              <div key={index} className="mb-4 flex items-center">
                ...
                />
                <label htmlFor={`option-${option}`} className="text-gray-800">
                  {option}
                </label>
              </div>
            ))}
