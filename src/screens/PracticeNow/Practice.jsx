...
//       // If we're on the system check step (step 2) and questions get loaded, navigate automatically
//       if (currentStep === 2 && chosenCompany && audioValidated && videoValidated) {
//         setShowLoading(false);
//         navigate("/interview");
//       }
//     }
//   }, [questionsList, setQuestions, hideLoader, currentStep, chosenCompany, audioValidated, videoValidated, navigate, questionsLoading]);
...
//             const checkQuestionsInterval = setInterval(() => {
//               if (questionsList?.questions?.length > 0) {
//                 // Once questions are available, navigate immediately
//                 clearInterval(checkQuestionsInterval);
