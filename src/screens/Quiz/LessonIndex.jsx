...
export default function LessonIndex() {
            ...
            <div className="grid gap-2">
              ...
              <div className="p-2 flex flex-col gap-y-2 ">
                ...
                <div className="font-light text-sm">
                  In the following section, we will work on how do we style the components using CSS
                  modules and how to create a nice user-friendly mobile responsive website.
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="py-2 item-self-end w-full">
                <Button
                  className="font-bold w-full  py-2"
          ...
          <div className="shadow-lg flex flex-col  h-full  bg-gray-200  rounded-lg overflow-hidden outline outline-purple-300">
            ...
            <div>
              ...
              <div className="grid justify-center items-center">
                <Button
                  endIcon={
                    <HttpsOutlinedIcon style={{ fontSize: "40px" }} className="text-purple-400" />
                  }
                  disabled
                >
                  {" "}
  ...
  return (
    <div className="w-full h-full overflow-y-auto px-4 ">
      <div className="text-3xl font-bold text-purple-800">Lessons</div>
