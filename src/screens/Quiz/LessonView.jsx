  ...
  return (
    <div className="w-full h-full">
      <TabContext value={value}>
          ...
          <div className="grid">
            ...
            <div className="mb-5 w-full flex justify-end ">
              <Button
                ...
                style={{ background: "linear-gradient(-45deg,#1c85ce , #5271ff)" }}
                onClick={() => {
                  setValue("2");
                }}
              >
        ...
        <TabPanel value="2" className="h-full w-full p-0 pb-4 overflow-y-scroll">
          <QuizPage id={1} setValue={setValue} />
        </TabPanel>
      </TabContext>
    </div>
  );
