  ...
  return (
    <motion.div
      className={`w-full h-auto mx-auto inline-block rounded-lg overflow-hidden cursor-pointer 
        shadow-md bg-[#F0F0F0] hover:shadow-2xl transition-shadow duration-300 transform ${
          quiz.is_locked ? "opacity-50 pointer-events-none" : "hover:scale-105"
        }`}
        ...
        <div className="flex flex-col justify-between items-center p-2 border rounded-lg shadow-md bg-white md:flex-row">
          {quiz.status != "Evaluation completed" && (
            <div className="flex flex-col items-center mb-4 md:flex-row md:mb-0">
              <div className="flex text-md mr-4">{quiz.questions?.length} Questions</div>
            </div>
          )}
  ...
  return (
    <div className="max-w-8xl mx-auto p-8">
      <div className="flex justify-end">
        <div
          className={` px-8 py-4 flex rounded-lg gap-6`}
          style={{
            backgroundColor: linearGradientBackground,
          }}
        >
          <div className="flex bg-white px-4 py-4 w-[50%] rounded-lg">
            <p className="w-[60%] text-md flex justify-center items-center">
              No. of Quizzes Attended
            </p>
            <h1 className="w-[40%] text-3xl font-bold flex justify-center items-center">0</h1>
          </div>
          <div className="flex bg-white px-4 py-4 w-[50%] rounded-lg">
            <p className="w-[65%] text-md flex justify-center items-center">
              No. of Pending Quizzes
            </p>
            <h1 className="w-[35%] text-3xl font-bold flex justify-center items-center">
