...
const dummyquestions = [
  {
    ...
    options: ["Newton", "Matt Lab", "James Gosling", "Ada Lovelace"],
    marks: 1,
    correct_option: [],
    selected_option: [3],
    answerType: "single",
  },
  {
    ...
    options: ["Encapsulation", "Association", "Aggregation", "Composition"],
    marks: 0,
    correct_option: [],
    selected_option: [4],
    answerType: "single",
...
const dummyanswers = [
  {
    all_options: ["Newton", "Matt Lab", "James Gosling", "Ada Lovelace"],
    correct_answers: ["James Gosling"],
    is_correct: true,
    marks: 1,
    question_id: 1,
    selected_options: [3],
  ...
  {
    all_options: ["Encapsulation", "Association", "Aggregation", "Composition"],
    correct_answers: ["Composition"],
    is_correct: true,
    marks: 0,
    question_id: 2,
    selected_options: [4],
...
export default function QuizPage({ setValue }) {
  ...
  return viewResults ? (
    ...
    <div className="quiz-container">
      {" "}
      <div className="quiz-header flex items-center justify-between p-4 shadow-lg bg-white rounded-lg">
        <Button
          variant="outlined"
          className="mr-4"
