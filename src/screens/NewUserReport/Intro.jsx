        ...
        <div className="flex items-center">
          ...
          <div className="ml-4 md:ml-7">
            ...
            <h1 className="text-2xl md:text-3xl font-extrabold mb-4">
              Candidate Interview<br></br> Answer Analysis Report
            </h1>
          </div>
        </div>
            ...
            <div className="flex justify-center items-center mb-5">
              <div className="munsow-light-bg px-6 py-4 rounded-full">
                <p className="text-lg">
                  Hard Skills:{" "}
                  {formatSkills(
                    Object.keys(report_data?.hard_and_soft_skill_dic?.hard_skill || {})
                  )}
                </p>
                <p className="text-lg">
                  Soft Skills:{" "}
                  {formatSkills(
                    Object.keys(report_data?.hard_and_soft_skill_dic?.soft_skill || {})
                  )}
                </p>
              </div>
            </div>
