    ...
    <>
      <div className="mx-3 my-3 md:mx-6 md:my-6">
        {report_data?.interview_type === "skill_interview" ? (
          <>
            <div
              className={`flex justify-around max-[425px]:items-start items-center pb-4 lg:pb-8 mb-8 ${bgColor}`}
            >
              <h1
                className={`mx-2 max-[375px]:text-xl text-2xl lg:text-4xl font-semibold text-purple`}
              >
                {head}&nbsp;Deep&nbsp;Dive
              </h1>
              <div className="mx-4 text-center bg-white p-2 lg:p-6 rounded-b-3xl">
                <h1
                  className={`max-[375px]:text-2xl text-3xl lg:text-4xl font-bold ${getScoreColor(formatScore(queScore))}`}
                >
                  {queScore ? `${formatScore(queScore)}/10` : "0/10"}
                </h1>
                <p className="max-[375px]:text-lg text-xl font-semibold text-purple">
                  Overall Score
                </p>
              </div>
            </div>
          ...
          <>
            <div
              className={`flex justify-around max-[425px]:items-start items-center pb-4 lg:pb-8 mb-8 bg-green`}
            >
              <h1
                className={`mx-2 max-[375px]:text-xl text-2xl lg:text-4xl font-semibold text-purple`}
              >
                JD Interview Deep Dive
              </h1>
              <div className="mx-4 text-center bg-white p-2 lg:p-6 rounded-b-3xl">
                <h1
                  className={`max-[375px]:text-2xl text-3xl lg:text-4xl font-bold ${getScoreColor(formatScore(queScore))}`}
          ...
          <>
            <div
              className={`flex justify-around max-[425px]:items-start items-center pb-4 lg:pb-8 mb-8 bg-purple`}
            >
              <h1
                className={`mx-2 max-[375px]:text-xl text-2xl lg:text-4xl font-semibold text-purple`}
              >
                Cultural Interview Deep Dive
              </h1>
              <div className="mx-4 text-center bg-white p-2 lg:p-6 rounded-b-3xl">
                <h1
                  className={`max-[375px]:text-2xl text-3xl lg:text-4xl font-bold ${getScoreColor(formatScore(queScore))}`}
        ...
        <div className="p-4 grid max-w-xl grid-cols-1 gap-x-8 gap-y-6 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
          ...
          <div className="">
            <h3 className="text-lg font-semibold italic text-purple mb-4">
        ...
        {gotRight && gotWrong && (
          <div className="p-4">
            ...
            <div className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-6 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
              {gotRight && (
                <div className="">
                  <h3 className="text-sm font-semibold italic text-darkgreen bg-lightgreen p-3 rounded-2xl inline-flex mb-4">
                    <AiOutlineLike color="green" className="m-0.5" />
                    What you got right
                  </h3>
              ...
              {gotWrong && (
                <div className="">
                  <h3 className="text-sm font-semibold italic text-darkred bg-lightred p-3 rounded-2xl inline-flex mb-4">
                    <FaRegThumbsDown color="brown" className="m-1" />
                    What you got wrong
                  </h3>
        ...
        {feedback && (
          <div className="p-4">
            <div className="mb-4">
              <h3 className="text-lg font-semibold italic text-purple">
