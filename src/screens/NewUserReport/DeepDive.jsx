  ...
  return (
    ...
    <>
      <div className="mx-3 my-3">
        ...
        <div className="p-4 grid max-w-xl grid-cols-1 gap-x-8 gap-y-6 lg:max-w-full sm:max-w-full lg:grid-cols-2 lg:gap-y-16">
          <div className="">
        ...
        <div className="p-4">
          ...
          <div className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-6 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
            <div className="">
              <h3 className="text-sm font-semibold italic text-darkgreen bg-lightgreen p-2 inline-flex mb-4  rounded-xl"><AiOutlineLike color="green" className="m-0.5" />What you got right</h3>
              <p className="bg-lightgreen text-purple rounded-3xl p-4">{gotRight}</p>
            </div>
            <div className="">
              <h3 className="text-sm font-semibold italic text-darkred bg-lightred p-2 inline-flex mb-4 rounded-xl"><FaRegThumbsDown color="brown" className="m-1" />What you got wrong</h3>
