            ...
            <TableBody>
              {usersList.map(row => (
                <TableRow key={row?.id} sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                  ...
                  <TableCell align="">
                    {row?.role_id === 1 ? "Admin" : row?.role_id === 2 ? "Teacher" : "Student"}
                  </TableCell>
                  <TableCell align="">
                    <Switch
                      color="secondary"
            ...
            >
              ...
              <div className="grid gap-4 ">
                <TextField
                  ...
                  variant="standard"
                  style={{ width: "100%" }}
                  onChange={event => onLogingChange("user_name", event.target.value)}
                  InputProps={{
                    startAdornment: (
                ...
                <TextField
                  ...
                  variant="standard"
                  style={{ width: "100%" }}
                  onChange={event => onLogingChange("password", event.target.value)}
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">
                ...
                <TextField
                  ...
                  variant="standard"
                  style={{ width: "100%" }}
                  onChange={event => onLogingChange("institution", event.target.value)}
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">
                ...
                <Autocomplete
                  ...
                  renderInput={params => (
                    <TextField variant="standard" {...params} label="Select Role" />
                  )}
                />
