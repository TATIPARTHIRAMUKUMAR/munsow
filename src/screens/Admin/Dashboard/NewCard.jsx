  ...
  return (
    <>
      <div className="grid md:grid-cols-3 gap-4">
        <div
          className="shadow-lg col-span-1 md:col-span-2 gap-5 grid grid-cols-1 md:grid-cols-2 p-5 rounded-xl"
        ...
        <div
          className="shadow-lg grid md:grid-rows-2 gap-5 p-5 rounded-xl"
          style={{ backgroundColor: "#fff" }}
        >
