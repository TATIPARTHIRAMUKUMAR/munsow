        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <FormControl component="fieldset" className="mb-4">
              <FormLabel component="legend" className="text-lg font-bold text-gray-700">
                Select Entity Type
              </FormLabel>
              <RadioGroup name="entity_type" onChange={handleChange} className="mt-2 flex flex-col">
                <FormControlLabel
                  value="institution"
                  control={<Radio style={{ color: "#2BE2D0" }} />}
                  label="I am Institution"
                />
                <FormControlLabel
                  value="corporate"
                  control={<Radio style={{ color: "#2BE2D0" }} />}
                  label="I am Corporate/Others"
                />
              </RadioGroup>
            </FormControl>
          </div>
