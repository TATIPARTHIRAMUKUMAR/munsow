...
const AddStudents = () => {
  ...
  const onHandleCreate = () => {
    ...
    dispatch(
      user_create(payload, { mode: "student" }, () => {
        setMainData({});
      })
    );
  };
        ...
        <TabPanel value="1" style={{ background: "white", borderRadius: "8px", marginTop: "10px" }}>
          <div className="">
            <div className="flex justify-between">
              ...
              <div className="flex justify-between items-center gap-2 text-lg font-semibold text-[#4e3f6e] cursor-pointer">
                <a href={`${GLOBAL_CONSTANTS?.backend_url}user/download`}>
                  <Button
                    endIcon={<CloudDownloadOutlinedIcon />}
            ...
            <div className="col-lg-12 mt-2">
              <div className="flex justify-start items-start">
                <span className="text-base font-normal">
                  Download the excel file template from above and fill in the details, and our tool
                  will automatically pick them up on import
                </span>
              </div>
            </div>
        ...
        <TabPanel value="2" style={{ background: "white", borderRadius: "8px", marginTop: "10px" }}>
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button
              ...
              style={
                !isFormValid
                  ? { background: "#91c7c2", color: "#8c8c8c" }
                  : { background: "#2BE2D0", color: "#252525" }
              }
              onClick={() => {
                onHandleCreate();
              }}
