    ...
    <div className="p-4">
      <div className="flex items-center bg-yellow-100 text-yellow-800 p-4 mb-4 rounded-md">
        ...
        <Typography variant="body1">
          <strong>Warning:</strong> You can delete or add an existing one, but any attempt to rename
          will be considered as a new record, and the old one will be deleted.
        </Typography>
      </div>
          ...
          <div className="mt-4">
            ...
            >
              ...
              <div className="text-center">
                <img src={UploadImage} className="w-[100px] mx-auto" alt="Upload Icon" />
