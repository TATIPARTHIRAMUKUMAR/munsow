...
const QuestionBankForm = () => {
  ...
  const configurationOptions = [{ label: "QUESTION BANK", key: "question" }];
  ...
  return (
    <div className="min-h-screen pt-5 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Paper
          elevation={0}
          className="overflow-hidden mb-6 bg-gradient-to-br from-indigo-50 to-pink-50"
        >
        ...
        {questionBank.method === "addUI" &&
          questionBank.questions.map((question, index) => (
            <Paper
              key={index}
              className="overflow-hidden rounded-lg shadow mb-6 bg-gradient-to-br from-indigo-50 to-pink-50"
            >
              <div className="p-6">
                ...
                <div className="flex">
                  <FormControl component="fieldset" className="mb-4">
                    <FormLabel component="legend" className="text-lg font-medium text-gray-700">
                      Answer Type
                    </FormLabel>
                    <RadioGroup
                      row
