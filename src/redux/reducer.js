...
const DataReducers = (state = initialState, action) => {
  switch (action.type) {
    ...
    case types.HARD_SKILLS_LIST:
      return {
        ...state,
        hardSkillsList: action.payload,
        loading: false,
      };
    case types.SOFT_SKILLS_LIST:
      return {
        ...state,
        softSkillsList: action.payload,
        loading: false,
      };
    case types.INTERVIEW_ROLES_LIST:
      return {
        ...state,
        interviewRolesList: action.payload,
        loading: false,
      };
    case types.COMPANIES_LIST:
      return {
        ...state,
        companiesList: action.payload,
        loading: false,
      };
    case types.EMOTION_STATS:
      return {
        ...state,
    ...
    case types.USER_REPORT_LIST:
      return {
        ...state,
        userReportList: action.payload?.data,
        loading: false,
      };
    case types.INSTITUTION_LIST:
      return {
        ...state,
    ...
    case types.INTERVIEW_QUESTIONS:
      return {
        ...state,
        questionsList: action.payload,
        loading: false,
      };
    case types.SUMMARY_DATA:
      return {
        ...state,
        summaryData: action.payload,
        loading: false,
      };
    case types.BEHAVIOUR_ANALYSIS:
      return {
        ...state,
    ...
    case types.USERS_LIST_BY_DEPARTMENT:
      return {
        ...state,
        userListByDepartment: action.payload.data,
        loading: false,
      };
    case types.ASSIGNED_USERS:
      return {
        ...state,
    ...
    case types.SCREENING_USER_LINKS_LIST:
      return {
        ...state,
        linksList: action.payload.data,
        loading: false,
      };
    case types.PLACEMENT_TRCKER:
      return {
        ...state,
    ...
    case types.QUESTIONBANKS:
      return {
        ...state,
        questionBanksList: action.payload.data,
        loading: false,
      };
    case types.PRACTICAL_THINKING:
      return {
        ...state,
...
//   userReportList:[],
//   questionsList:[],
//   interviewResults: null, // NEW: Added for interview results
//   behaviourAnalysis:[],
//   ksAnalysis: [],
//   ksFilters: [],
//   userListByDepartment:[],
...
//       loading:false
//     }
//     // NEW: Handle interview results
//     case types.INTERVIEW_RESULTS: return{
//       ...state,
//       interviewResults:action.payload,
//       loading:false
//     }
//     // NEW: Clear interview results
//     case types.CLEAR_INTERVIEW_RESULTS: return{
//       ...state,
